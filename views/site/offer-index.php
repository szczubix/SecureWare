...
<section class="sw-hero" style="padding:64px 0;">
    <div class="sw-wrap">
        <span class="sw-hero__eyebrow">Oferta</span>
        <h1 style="font-size:36px;">Pelen zakres ochrony <span>danych</span> dla firm</h1>
        <p class="lead">13 uslug pokrywajacych caly cykl zycia backupu — od wdrozenia, przez codzienne zarzadzanie, po disaster recovery i testy odtwarzania.</p>
    </div>
</section>
