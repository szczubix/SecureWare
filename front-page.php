        ...
        <div class="sw-hero__content">
            ...
            <div class="sw-hero__buttons">
                ...
                <a href="#sw-categories" class="sw-btn sw-btn--secondary sw-btn--lg">
                    <?php esc_html_e( 'Zobacz kategorie', 'secureware' ); ?>
                </a>
            </div>
            ...
            <div class="sw-hero__stats">
                ...
                <div class="sw-hero__stat">
                    ...
                    <div class="sw-hero__stat-label"><?php esc_html_e( 'Zadowolonych klientów', 'secureware' ); ?></div>
                </div>
                <div class="sw-hero__stat">
                    <div class="sw-hero__stat-value"><?php echo esc_html( get_theme_mod( 'secureware_stat_delivery', '< 1 min' ) ); ?></div>
                    <div class="sw-hero__stat-label"><?php esc_html_e( 'Czas dostawy', 'secureware' ); ?></div>
                </div>
                <div class="sw-hero__stat">
                    <div class="sw-hero__stat-value"><?php echo esc_html( get_theme_mod( 'secureware_stat_support', '24/7' ) ); ?></div>
                    <div class="sw-hero__stat-label"><?php esc_html_e( 'Wsparcie techniczne', 'secureware' ); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="sw-features">
    <div class="sw-container">
        <div class="sw-features__header">
            <h2><?php esc_html_e( 'Dlaczego SecureWare?', 'secureware' ); ?></h2>
            <p><?php esc_html_e( 'Oferujemy najlepsze warunki zakupu licencji na oprogramowanie', 'secureware' ); ?></p>
        </div>
        <div class="sw-grid sw-grid-4">
            <div class="sw-feature-card">
                ...
                <p class="sw-feature-card__desc"><?php esc_html_e( 'Klucz licencyjny otrzymasz na e-mail w ciągu kilku sekund po zakupie.', 'secureware' ); ?></p>
            </div>
            <div class="sw-feature-card">
                <div class="sw-feature-card__icon">
                ...
                <p class="sw-feature-card__desc"><?php esc_html_e( 'Wszystkie licencje są oryginalne i pochodzą od autoryzowanych dystrybutorów.', 'secureware' ); ?></p>
            </div>
            <div class="sw-feature-card">
                <div class="sw-feature-card__icon">
                ...
                <p class="sw-feature-card__desc"><?php esc_html_e( 'Konkurencyjne ceny i regularne promocje na najpopularniejsze produkty.', 'secureware' ); ?></p>
            </div>
            <div class="sw-feature-card">
                <div class="sw-feature-card__icon">
                ...
                <p class="sw-feature-card__desc"><?php esc_html_e( 'Nasz zespół pomoże Ci z instalacją i aktywacją oprogramowania.', 'secureware' ); ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="sw-categories" id="sw-categories">
    <div class="sw-container">
        <div class="sw-products__header">
            ...
            <p><?php esc_html_e( 'Znajdź oprogramowanie, którego potrzebujesz', 'secureware' ); ?></p>
        </div>
        <div class="sw-grid sw-grid-3">
            ...
            ?>
                <div class="sw-category-card">
                    <div class="sw-category-card__icon">
                        <?php echo $category_icons[0]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                    </div>
                    <div>
                        <h3 class="sw-category-card__title"><?php esc_html_e( 'Systemy operacyjne', 'secureware' ); ?></h3>
                        <span class="sw-category-card__count"><?php esc_html_e( 'Windows, macOS, Linux', 'secureware' ); ?></span>
                    </div>
                </div>
                <div class="sw-category-card">
                    <div class="sw-category-card__icon">
                        <?php echo $category_icons[1]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                    </div>
                    <div>
                ...
                <div class="sw-category-card">
                    <div class="sw-category-card__icon">
                        <?php echo $category_icons[2]; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                    </div>
                    <div>
...
<section class="sw-products">
    <div class="sw-container">
        <div class="sw-products__header">
            <h2><?php esc_html_e( 'Polecane produkty', 'secureware' ); ?></h2>
            <p><?php esc_html_e( 'Najpopularniejsze licencje w naszym sklepie', 'secureware' ); ?></p>
        </div>
        <?php
        echo do_shortcode( '[products limit="8" columns="4" orderby="popularity" visibility="featured"]' );
        ?>
        <div style="text-align: center; margin-top: 2rem;">
            <a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" class="sw-btn sw-btn--secondary">
                <?php esc_html_e( 'Zobacz wszystkie produkty', 'secureware' ); ?>
...
<!-- Sale Products -->
<?php if ( class_exists( 'WooCommerce' ) ) : ?>
<section class="sw-products" style="background: var(--sw-bg-secondary);">
    <div class="sw-container">
        <div class="sw-products__header">
            <h2><?php esc_html_e( 'Promocje', 'secureware' ); ?></h2>
            <p><?php esc_html_e( 'Nie przegap okazji - najlepsze ceny na rynku', 'secureware' ); ?></p>
        </div>
        <?php
        echo do_shortcode( '[products limit="4" columns="4" on_sale="true" orderby="date"]' );
        ?>
    </div>
</section>
<?php endif; ?>
...
<section class="sw-cta">
    <div class="sw-container">
        <div class="sw-cta__box">
            <h2 class="sw-cta__title"><?php echo esc_html( get_theme_mod( 'secureware_cta_title', __( 'Bądź na bieżąco z promocjami', 'secureware' ) ) ); ?></h2>
            <p class="sw-cta__desc"><?php echo esc_html( get_theme_mod( 'secureware_cta_description', __( 'Zapisz się do newslettera i otrzymuj informacje o najnowszych promocjach i produktach.', 'secureware' ) ) ); ?></p>
